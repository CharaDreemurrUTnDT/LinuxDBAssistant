...
def print_ascii_logo():
    ...
    """
    print(ascii_logo)
    print("Created by CharaDreemurrUTnDT on Github")


def verify_iso_integrity(iso_path, user_hash):
    ...
    print("Select the hash algorithm for verification:")
    print("[1.] md5")
    print("[2.] sha256")
    hash_choice = input("Enter the number of your choice (1 or 2): ")
    ...
    if hash_choice == "1":
        ...
        print("Invalid choice. Exiting verification.")
        return

    # Calculate the ISO checksum
    print(f"Calculating ISO checksum using {hash_algo}...")
    import hashlib
    ...
    # Verify checksum against user-provided hash
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            user_hash = input("Enter the checksum hash to verify against: ")
            verify_iso_integrity(iso_path, user_hash)
        elif choice == "4":
            install_refind()
        elif choice == "5":
            print("Exiting...")
...
if __name__ == "__main__":
    # Initialize the file dialog root window
    tk.Tk().withdraw()  # Hides the main tkinter window
    main()